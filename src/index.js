...
io.on('connection', (socket) => {
    ...
    socket.on('join', (options, callback) => {
        ...
        socket.emit('message', generateMessage('Admin', 'Welcome!')) // send particular connection
        socket.broadcast.to(user.room).emit('message', generateMessage('Admin', `${user.username} has joined!`)) // send except yourself
